...
CREATE TABLE #ProcessingStack (
    ...
    ConfigSectionType nvarchar(128),
...
SELECT DISTINCT
    E.PrimKey,
    S.StepType,
    ConfigSectionType = json_value(ConfigSections.value, '$.Type'),
    ConfigSection = ConfigSections.value,
    ConfigSectionPath = '$.' + ConfigSections.[key],
    ConfigSections.type
FROM
    ...
    CROSS APPLY OPENJSON(E.EndpointConfig) AS ConfigSections
WHERE
    ISJSON(ConfigSections.value) = 1
    AND ConfigSections.type = 5
    AND json_value(ConfigSections.value, '$.Type') IS NOT NULL
        ...
        when Type = 1 then
            ...
            (
                ...
                (
                    ...
                    where
                        S.StepType = T.StepType
                        and S.ConfigSectionType = T.ConfigSectionType
